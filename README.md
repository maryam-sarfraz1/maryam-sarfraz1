...
[![Typing SVG](https://readme-typing-svg.demolab.com?font=Poppins&weight=600&size=22&pause=1000&color=B07FD4&center=true&vCenter=true&width=520&lines=%E2%9C%A8+Turning+ideas+into+working+software;Python+%7C+C%2B%2B+%7C+JavaScript+%7C+TypeScript;Always+learning%2C+always+building+%F0%9F%8C%B8)](https://git.io/typing-svg)
...
| 🌟 Project | 💻 Tech | 📝 About |
|---|---|---|
| 🌉 [**SkillBridge-PK**](https://github.com/maryam-sarfraz1/SkillBridge-PK) | JavaScript | A platform to connect people to share & learn skills |
| 🏥 [**Hospital Triage & Bed Allocator**](https://github.com/maryam-sarfraz1/Hospital-Patient-Triage-Bed-Allocator-System) | C | Prioritizes patients & allocates hospital beds |
| 💖 [**Lovable**](https://github.com/maryam-sarfraz1/Lovable) | TypeScript | A modern, friendly web application |
| 🧭 [**path_finder**](https://github.com/maryam-sarfraz1/path_finder) | Python | Pathfinding algorithm visualizer & solver |
| 🐱 [**Nyan-cat-vs-cheeseburger**](https://github.com/maryam-sarfraz1/Nyan-cat-vs-cheeseburger) | C++ | A fun arcade-style game |
| 👹 [**Wumpus**](https://github.com/maryam-sarfraz1/Wumpus) | Python | Classic "Hunt the Wumpus" logic game |
| 🕹️ [**wumpus_**](https://github.com/maryam-sarfraz1/wumpus_) | Python | Another take on the Wumpus game |
| ⚖️ [**legalgram**](https://github.com/maryam-sarfraz1/legalgram) | — | A legal-tech project |
| 🌐 [**t_web**](https://github.com/maryam-sarfraz1/t_web) | — | A web development project |
| 📚 [**practice**](https://github.com/maryam-sarfraz1/practice) | — | Coding practice & experiments |

</div>

<sub>💡 Tip: open each repo and add a one-line description + topics so visitors instantly get what it does.</sub>
